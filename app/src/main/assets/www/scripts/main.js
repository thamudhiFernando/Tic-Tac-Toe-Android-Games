...
"use strict";
{
    window.DOMHandler = class DOMHandler {
        ...
        _PostToRuntimeMaybeSync(name, data, dispatchOpts) {
            ...
            else this._iRuntime._GetLocalRuntime()["_OnMessageFromDOM"]({ type: "event", component: this._componentId, handler: name, dispatchOpts: dispatchOpts || null, data: data, responseId: null });
        }
        ...
        AddRuntimeMessageHandlers(list) {
            for (const [handler, func] of list) this.AddRuntimeMessageHandler(handler, func);
        }
        GetRuntimeInterface() {
...
("use strict");
{
    ...
    const supportedAudioFormats = {
        "audio/webm; codecs=opus": !!tmpAudio.canPlayType("audio/webm; codecs=opus") && !isSafari,
    ...
    window.RuntimeInterface = class RuntimeInterface {
        ...
        async _Init(opts) {
            if (this._exportType === "macos-wkwebview") this._SendWrapperMessage({ type: "ready" });
            if (this._exportType === "playable-ad") {
                ...
                for (let i = 0, len = opts.engineScripts.length; i < len; ++i) {
                    ...
                    if (this._localFileStrings.hasOwnProperty(src)) opts.engineScripts[i] = { isStringSrc: true, str: this._localFileStrings[src] };
        ...
        async _InitWorker(opts, port2) {
            ...
            this._worker = await this.CreateWorker(workerMainUrl, this._baseUrl, { type: "module", name: "Runtime", isC3MainWorker: true });
        ...
        async _InitDOM(opts, port2) {
            ...
            const runtimeOpts = Object.assign(this._GetCommonRuntimeOptions(opts), { isInWorker: false, messagePort: port2, canvas: this._canvas, runOnStartupFunctions: runOnStartupFunctions });
        ...
        PostToRuntimeComponent(component, handler, data, dispatchOpts, transferables) {
            this._messageChannelPort.postMessage({ type: "event", component: component, handler: handler, dispatchOpts: dispatchOpts || null, data: data, responseId: null }, transferables);
        }
        PostToRuntimeComponentAsync(component, handler, data, dispatchOpts, transferables) {
            ...
            this._messageChannelPort.postMessage({ type: "event", component: component, handler: handler, dispatchOpts: dispatchOpts || null, data: data, responseId: responseId }, transferables);
            return ret;
        }
        ...
        _PostResultToRuntime(responseId, isOk, result) {
            ...
            this._messageChannelPort.postMessage({ type: "result", responseId: responseId, isOk: isOk, result: result }, transferables);
        }
        ...
        async _WasmDecodeWebMOpus(arrayBuffer) {
            const result = await this.PostToRuntimeComponentAsync("runtime", "opus-decode", { arrayBuffer: arrayBuffer }, null, [arrayBuffer]);
...
("use strict");
{
    ...
    const HANDLER_CLASS = class RuntimeDOMHandler extends self.DOMHandler {
        ...
        _OnWindowResize() {
            ...
            this._PostRuntimeEvent("window-resize", { innerWidth: width, innerHeight: height, devicePixelRatio: window.devicePixelRatio, isFullscreen: RuntimeInterface.IsDocumentFullscreen() });
        ...
        _OnFullscreenError(e) {
            ...
            this.PostToRuntime("fullscreenerror", { isFullscreen: RuntimeInterface.IsDocumentFullscreen(), innerWidth: this._GetWindowInnerWidth(), innerHeight: this._GetWindowInnerHeight() });
        }
        ...
        _OnKeyEvent(name, e) {
            ...
            this._PostToRuntimeMaybeSync(
                name,
                { code: code, key: e.key, which: e.which, repeat: e.repeat, altKey: e.altKey, ctrlKey: e.ctrlKey, metaKey: e.metaKey, shiftKey: e.shiftKey, timeStamp: e.timeStamp },
        ...
        _OnMouseWheelEvent(name, e) {
            this.PostToRuntime(
                name,
                { clientX: e.clientX, clientY: e.clientY, pageX: e.pageX, pageY: e.pageY, deltaX: e.deltaX, deltaY: e.deltaY, deltaZ: e.deltaZ, deltaMode: e.deltaMode, timeStamp: e.timeStamp },
                DISPATCH_RUNTIME_AND_SCRIPT
            );
        }
        _OnMouseEvent(name, e, opts) {
            if (IsCompatibilityMouseEvent(e)) return;
            this._PostToRuntimeMaybeSync(name, { button: e.button, buttons: e.buttons, clientX: e.clientX, clientY: e.clientY, pageX: e.pageX, pageY: e.pageY, timeStamp: e.timeStamp }, opts);
        }
        ...
        _OnDeviceMotion(e) {
            ...
            if (rotationRate) rotationRateProp = { alpha: rotationRate["alpha"] || 0, beta: rotationRate["beta"] || 0, gamma: rotationRate["gamma"] || 0 };
            this.PostToRuntime("devicemotion", { acceleration: accProp, accelerationIncludingGravity: withGProp, rotationRate: rotationRateProp, interval: e["interval"], timeStamp: e.timeStamp }, DISPATCH_RUNTIME_AND_SCRIPT);
        }
...
("use strict");
{
    ...
    self.JobSchedulerDOM = class JobSchedulerDOM {
        ...
        async Init() {
            ...
            this._dispatchWorker.postMessage({ type: "_init", "in-port": messageChannel.port2 }, [messageChannel.port2]);
        ...
        async _CreateJobWorker() {
            ...
            jobWorker.postMessage({ type: "init", number: number, "dispatch-port": dispatchChannel.port2, "output-port": outputChannel.port2 }, [dispatchChannel.port2, outputChannel.port2]);
...
("use strict");
{
    ...
    function angleLerp(a, b, x) {
        ...
        if (angleClockwise(b, a)) return clampAngle(a + diff * x);
        else return clampAngle(a - diff * x);
    }
    class C3NetValue {
        ...
        GetRuntimeData() {
            return { tag: this._tag, interp: this._interp, userData: this._userData, cvt: this._clientValueTag };
        }
        GetIndex() {
            return this._index;
        }
    ...
    class C3NetInstance {
        constructor(ro, id, nid) {
            ...
            this._nid = nid;
            this._data = [];
            this._data.length = this._ro.GetNetValues().length;
            this._lastChanged = 0;
        ...
        GetRuntimeData() {
            ...
            const ret = { id: this._id, nid: this._nid, isTimedOut: this.IsTimedOut(), interpValues: interpValues, latestUpdate: null };
        ...
        UpdateData(data, nowTime) {
            ...
            if (timeSinceChanged < 100 && bandwidth === 0) this._transmitMe = true;
            else if (timeSinceChanged < 1e3 && bandwidth <= 1) this._transmitMe = timeSinceTransmit >= 95;
            else this._transmitMe = timeSinceTransmit >= 495;
        ...
        IsTimedOut() {
            if (this._updates.length === 0) return false;
        ...
        GetInterp(simTime, valueIndex, noExtrapolate) {
            ...
            if (!this._nextUpdate && this._priorUpdate)
                if (this._priorUpdate2 && !noExtrapolate) {
                    ...
                    return C3NetValue.InterpNetValue(netValues[valueIndex].GetInterp(), fromVal, toVal, x, true);
    ...
    class C3RegisteredObject {
        ...
        AddValue(interp, precision, tag, userData, clientValueTag) {
        ...
        GetNetValuesJson() {
            ...
            for (const v of this._netValues) {
                const o = { tag: v.GetTag(), precision: v.GetPrecision(), interp: v.GetInterp(), clientvaluetag: v.GetClientValueTag() };
        ...
        RemoveNetInstance(netInst) {
            ...
            if (i > -1) this._netInstances.splice(i, 1);
        }
        ...
        GetRuntimeData() {
            return { hasOverriddenNids: this.HasOverriddenNids(), netValues: this._netValues.map((nv) => nv.GetRuntimeData()), netInstances: this._netInstances.map((ni) => ni.GetRuntimeData()) };
        }
...
("use strict");
{
    ...
    class C3Peer {
        ...
        _AttachDataChannelHandlers(dc, type) {
            ...
            dc.onopen = () => {
                if (type === "o") this._isOOpen = true;
                else if (type === "r") this._isROpen = true;
                else if (type === "u") this._isUOpen = true;
                this._MaybeFireOpen();
            };
            dc.onmessage = (m) => {
            ...
            dc.onerror = (err) => {
                ...
                if (this._domHandler.IsHost() && !this.IsHost()) this.Remove("network error");
            };
            dc.onclose = () => {
        ...
        Connect() {
            ...
            this._pc.onicecandidate = (e) => {
                if (e.candidate) this._domHandler.SignallingSend({ message: "icecandidate", toclientid: this._id, icecandidate: e.candidate });
            };
            ...
            if (isHost) {
                ...
                this._dcu = this._pc.createDataChannel("u", { ordered: false, maxRetransmits: 0, protocol: dc_protocol });
                ...
                this._pc.ondatachannel = (e) => {
                    if (e.channel.protocol !== dc_protocol) {
                        console.error("Unexpected datachannel protocol '" + e.channel.protocol + "', should be '" + dc_protocol + "'");
                    ...
                    if (label === "o") this._dco = e.channel;
                    else if (label === "r") this._dcr = e.channel;
                    else if (label === "u") this._dcu = e.channel;
                    else {
                    ...
                    this._AttachDataChannelHandlers(e.channel, label);
                };
        }
        ...
        _OnOpen() {
            ...
            if (this._domHandler.IsHost()) {
                this._domHandler.HostBroadcast("o", JSON.stringify({ c: "j", i: this._id, n: this._nid, a: this._alias }), this);
                this.Send(
                    "o",
                    JSON.stringify({
                        c: "hi",
                ...
                for (const p of this._domHandler.peers()) {
                    ...
                    this.Send("o", JSON.stringify({ c: "j", i: p.GetId(), n: p.GetNid(), a: p.GetAlias() }));
                }
            } else {
        ...
        _OnClose(reason) {
            if (this._domHandler.IsHost() && !this.IsSelf()) this._domHandler.HostBroadcast("o", JSON.stringify({ c: "l", i: this._id, a: this._alias, r: reason }), this);
        ...
        Send(type, m) {
            ...
            let messageSize = 0;
            if (m.length) messageSize = m.length;
            else if (m.byteLength) messageSize = m.byteLength;
            ...
            if (simulatedLatency === 0 && simulatedPdv === 0) this._DoSend(type, m);
            else {
                let multiplier = 1;
                ...
                if (this._domHandler.IsHost())
                    if (type === "o" || type === "r") {
                        ...
                        if (this._errorCount >= 10) {
                            if (typeof m === "string") {
                                console.error("Too many errors (" + this._errorCount + ") sending data on '" + type + "' to '" + this._alias + "', kicking; last error was for sending " + m.length + "-char string: ", err);
                                console.log("String that failed to send from previous error was: " + m);
                            } else
                                console.error("Too many errors (" + this._errorCount + ") sending data on '" + type + "' to '" + this._alias + "', kicking; last error was for sending " + (m.length || m.byteLength) + "-byte binary: ", err);
                            this.Remove("network error");
                        }
                    }
        ...
        SendPong(pingStr) {
            let response = "pong:" + pingStr.substr(5);
            if (this._domHandler.IsHost()) {
                response += "/";
        ...
        _OnPong(str) {
            ...
            if (!this._domHandler.IsHost()) {
                ...
                if (slash > -1) {
                    const hostTime = parseFloat(str.substr(slash + 1));
                    if (isFinite(hostTime)) this._domHandler.AddHostTime(hostTime, nowTime, lastLatency, this._latency);
                    else console.warn("Invalid host time from pong response");
        ...
        _OnMessage(type, m) {
            ...
            const simulatedPdv = this._domHandler.GetSimulatedPdv();
            if (simulatedPacketLoss > 0 && type === "u") if (Math.random() < simulatedPacketLoss) return;
            if (simulatedLatency === 0 && simulatedPdv === 0) this._DoOnMessage(type, m);
            else {
                let multiplier = 1;
                if (type !== "u" && Math.random() < simulatedPacketLoss) multiplier = 3;
        ...
        _DoOnMessage(type, m) {
            ...
            let messageSize = 0;
            if (m.data.length) messageSize = m.data.length;
            else if (m.data.byteLength) messageSize = m.data.byteLength;
            ...
            if (typeof m.data === "string") {
                ...
                try {
                    ...
                    } else console.error("Error parsing message as JSON for peer '" + this._id + "': ", err);
                    console.log("String that failed to parse from previous error: " + m.data);
                    return;
                }
                if (!o) return;
                try {
                    if (o["c"] && o["c"] !== "m") this._OnControlMessage(o);
                    else this._domHandler._OnPeerMessage(this, o);
                } catch (err) {
                    this._domHandler._OnPeerError(this, err);
                    if (this._domHandler.IsHost()) {
                ...
                if (!this._hasConfirmed && this._domHandler.IsHost() && type === "u") {
                    this._hasConfirmed = true;
        ...
        _OnControlMessage(o) {
            ...
            switch (o["c"]) {
                ...
                case "j":
                    if (!this._domHandler.IsHost()) {
                        peer = new C3Peer(this._domHandler, o["i"], o["a"]);
                        peer._SetNid(o["n"]);
        ...
        _AddClientUpdate(timestamp, data) {
        ...
        Tick(simTime) {
            ...
            while (this._clientStateUpdates.length > 2 && this._clientStateUpdates[0] !== this._priorUpdate2 && this._clientStateUpdates[0] !== this._priorUpdate && this._clientStateUpdates[0] !== this._nextUpdate)
                this._clientStateUpdates.shift();
            if (this._nextUpdate && this._nextUpdate.timestamp > simTime && this._priorUpdate && this._priorUpdate.timestamp < simTime) return;
            this._nextUpdate = null;
            for (let i = 0, len = this._clientStateUpdates.length; i < len; ++i) {
                const u = this._clientStateUpdates[i];
        ...
        _OnPeerUpdate(buffer) {
            ...
            ptr += 4;
            if (flags === 0) this._HandlePeerUpdate(view, ptr);
            else if (flags === 1) this._HandlePeerEvents(view, ptr);
            else console.warn("Ignoring packet with incorrect flags (received " + flags + ", expected 0 or 1");
        }
        ...
        _HandlePeerEvents(view, ptr) {
            ...
            for (let i = 0; i < robjCount; ++i) {
                ...
                for (let j = 0; j < lenj; ++j) {
                    ...
                    this._domHandler._OnInstanceDestroyed(ro, deadNid, timestamp);
        ...
        Remove(reason, isKick) {
            ...
            const pc = this._pc;
            setTimeout(() => {
                CloseIgnoreException(dco);
                CloseIgnoreException(dcr);
                CloseIgnoreException(dcu);
                CloseIgnoreException(pc);
            }, 0);
            this._dco = null;
            this._dcr = null;
            this._dcu = null;
        ...
        GetClientState(tag) {
            const cv = this._domHandler.GetClientValueByTag(tag);
            if (!cv) return 0;
            const i = cv.GetIndex();
        ...
        GetInterpClientState(cv) {
            ...
            if (!this._nextUpdate && this._priorUpdate)
                if (this._priorUpdate2) {
                    ...
                    const arr = this._priorUpdate.data;
                    if (i < 0 || i >= arr.length) return 0;
                    else return arr[i];
                }
            fromTime = this._priorUpdate.timestamp;
...
("use strict");
{
    ...
    const RTCIceCandidate = window["RTCIceCandidate"] || window["webkitRTCIceCandidate"] || window["mozRTCIceCandidate"] || window["msRTCIceCandidate"];
    ...
    const tempArray = [];
    const HANDLER_CLASS = class MultiplayerDOMHandler extends self.DOMHandler {
        constructor(iRuntime) {
            super(iRuntime, DOM_COMPONENT_ID);
            this._iceServers = [];
            this._sigWs = null;
            ...
            this._stats = { lastSecondTime: 0, outboundPerSec: 0, outboundCount: 0, outboundBandwidthPerSec: 0, outboundBandwidthCount: 0, inboundPerSec: 0, inboundCount: 0, inboundBandwidthPerSec: 0, inboundBandwidthCount: 0 };
            ...
            this.AddRuntimeMessageHandler("add-ice-servers", (e) => this._MergeICEServerList(e["list"]));
            ...
            this.AddRuntimeMessageHandler("signalling-disconnect", () => this.SignallingDisconnect());
            ...
            this.AddRuntimeMessageHandler("signalling-list-game-instances", (e) => this.SignallingRequestGameInstanceList(e["game"]));
            ...
            this.AddRuntimeMessageHandler("sync-object", (e) => this.OnSyncObject(e));
        ...
        _GetErrorMessage(err) {
            ...
            else if (typeof err["details"] === "string") return err["details"];
            else if (typeof err["data"] === "string") return err["data"];
            else if (typeof err["type"] === "string") return err["type"];
        ...
        _OnSignallingReceiveWelcome(o) {
            ...
            this.PostToRuntime("signalling-welcome", { myid: this._myId, sigservinfo: { protocolrev: ssi.protocolrev, version: ssi.version, name: ssi.name, operator: ssi.operator, motd: ssi.motd } });
        }
        _OnSignallingReceiveLoginOK(o) {
            this._myAlias = o["alias"];
            this._isSignallingLoggedIn = true;
        ...
        _OnSignallingReceiveJoinOK(o) {
            ...
            if (o["host"]) {
                ...
                this._targetSimDelay = this._clientDelay;
                this._simDelay = this._clientDelay;
                this._hostPeer = new C3Peer(this, o["hostid"], o["hostalias"]);
                this._hostPeer.Connect();
            }
            this.PostToRuntime("signalling-join-ok", { isHost: !!o["host"], hostId: this._hostPeer.GetId(), hostAlias: this._hostPeer.GetAlias(), game: this._game, gameInstance: this._gameInstance, room: this._room });
        }
        ...
        _OnSignallingReceiveOffer(o) {
            ...
            hostPc
                .setRemoteDescription(new RTCSessionDescription(o["offer"]))
                .then(() => {
                    hostPc
                        .createAnswer()
                        .then((answer) => {
                            hostPc.setLocalDescription(answer);
                            this.SignallingSend({ message: "answer", toclientid: this._hostPeer.GetId(), answer: answer });
                        })
                        .catch((err) => {
        ...
        _OnSignallingReceiveAnswer(o) {
            ...
            peer.GetPeerConnection()
                .setRemoteDescription(new RTCSessionDescription(o["answer"]))
                .catch((err) => {
        ...
        SignallingJoinGameRoom(game, instance, room, maxClients) {
            if (!this._isSignallingLoggedIn || this._room) return;
            this.SignallingSend({ message: "join", game: game, instance: instance, room: room, max_clients: maxClients });
        }
        SignallingAutoJoinGameRoom(game, instance, room, maxClients, lockWhenFull) {
            if (!this._isSignallingLoggedIn || this._room) return;
            this.SignallingSend({ message: "auto-join", game: game, instance: instance, room: room, max_clients: maxClients, lock_when_full: lockWhenFull });
        }
        SignallingLeaveRoom() {
            if (!this._isSignallingLoggedIn) return;
        ...
        SignallingConfirmPeer(id) {
            if (!this._isSignallingLoggedIn || !this.IsHost()) return;
        ...
        _RemovePeer(peer) {
            ...
            if (i > -1) this._allPeers.splice(i, 1);
        ...
        HostBroadcast(type, m, skipPeer) {
            ...
            for (const p of peersCopy) {
                if (!p) continue;
                if (p !== this._selfPeer && p !== skipPeer) p.Send(type, m);
            }
        }
        _DoPings() {
            const nowTime = performance.now();
        ...
        GetRegisteredObjectsMap() {
            const ret = {};
            for (const [nid, ro] of this._registeredObjectsByNid.entries()) ret[ro.GetSid()] = { nid: nid, nvs: ro.GetNetValuesJson() };
            return ret;
        }
        MapObjectNids(objs) {
            this._registeredObjectsByNid.clear();
            for (const ro of this._allRegisteredObjects)
                if (objs.hasOwnProperty(ro.GetSid().toString())) {
        ...
        GetRegisteredObjectByNid(nid) {
            return this._registeredObjectsByNid.get(nid) || null;
        }
        Tick(e) {
            ...
            if (nowTime - stats.lastSecondTime >= 1e3) {
                ...
                stats.inboundBandwidthPerSec = stats.inboundBandwidthCount;
                ...
                this.PostToRuntime("stats", {
                    stats: { outboundPerSec: stats.outboundPerSec, outboundBandwidthPerSec: stats.outboundBandwidthPerSec, inboundPerSec: stats.inboundPerSec, inboundBandwidthPerSec: stats.inboundBandwidthPerSec },
                });
            }
            if (!this.IsHost()) {
        ...
        _GetPeerRuntimeData() {
            ...
            for (const peer of this._allPeers) {
                ...
                ret[peer.GetId()] = { nid: peer.GetNid(), latency: peer.GetLatency(), pdv: peer.GetPdv(), clientState: clientStateData };
            }
            return ret;
        }
        ...
        async _OnBeforeClientUpdate() {
            const result = await this.PostToRuntimeAsync("before-client-update");
        ...
        async _SendClientUpdate(nowTime) {
            ...
            const timeSinceTransmit = nowTime - this._selfPeer.GetLastStateTransmit();
            let transmit = false;
            if (timeSinceChanged < 100) transmit = true;
            else if (timeSinceChanged < 1e3) transmit = timeSinceTransmit >= 95;
            else transmit = timeSinceTransmit >= 495;
            if (!transmit) return;
            ...
            this._hostPeer.Send("u", new Uint8Array(this._dataBuffer.slice(0, ptr)));
        }
        async _SendHostUpdate(nowTime) {
            ...
            this.HostBroadcast("u", new Uint8Array(this._dataBuffer.slice(0, ptr)), null);
        }
        _SendHostEvents(nowTime) {
            ...
            this.HostBroadcast("r", new Uint8Array(this._dataBuffer.slice(0, ptr)), null);
        }
        AddHostTime(hostTime, nowTime, lastLatency, latency) {
            if (this.IsHost()) return;
        ...
        GetSimulationTime() {
            if (this.IsHost()) return performance.now() - this._clientDelay;
            else return performance.now() + this._hostTimeDiff - this._simDelay;
        }
        GetHostTime() {
            if (this.IsHost()) return performance.now();
            else return performance.now() + this._hostTimeDiff;
        }
        ...
        AddClientInputValue(tag, precision, interp) {
            const cv = new C3NetValue(this._allClientValues.length, interp, precision, tag, null);
        ...
        GetClientValuesJson() {
            const ret = [];
            for (const cv of this._allClientValues) ret.push({ tag: cv.GetTag(), precision: cv.GetPrecision(), interp: cv.GetInterp() });
            return ret;
        }
        MapClientValues(arr) {
            ...
            for (let i = 0, len = arr.length; i < len; ++i) {
                const data = arr[i];
                const cv = new C3NetValue(i, data["interp"], data["precision"], data["tag"], null);
        ...
        _OnPeerClose(peer, reason) {
            this.PostToRuntime("peer-close", { id: peer.GetId(), alias: peer.GetAlias(), reason: reason || "unknown" });
        }
        ...
        _OnPeerMessage(peer, m) {
            ...
            this.PostToRuntime("peer-message", { tag: m["t"], fromId: senderPeerId, fromAlias: this.GetAliasFromId(senderPeerId), content: m["m"] });
        }
        _OnInstanceDestroyed(ro, nid, timestamp) {
            this.PostToRuntime("instance-destroyed", { roId: ro.GetRoId(), nid: nid, timestamp: timestamp });
        }
        OnKickPeer(e) {
            if (!this.IsHost()) return;
            const id = e["id"];
        ...
        OnSyncObject(e) {
            ...
            for (const ocData of e["objectClasses"]) {
                ...
                } else if (data === 2) ro.AddValue(INTERP_ANGULAR, precision, "a");
                else if (data === 3) {
                    ro.AddValue(INTERP_LINEAR, precision, "x");
                    ro.AddValue(INTERP_LINEAR, precision, "y");
        ...
        OnAssociateObject(e) {
            ...
            const peer = this._peersById.get(peerId);
            if (!ro || !peer) return;
...
("use strict");
{
    ...
    const HANDLER_CLASS = class ShareHandler extends self.DOMHandler {
        constructor(iRuntime) {
            ...
            this._isSupported = this._isWebShareSupported || hasCordovaPlugin;
...
("use strict");
{
    ...
    function SetInitConfigureOptions(id, pubID, privacyPolicy, showFree, showConsent, debug, debugLocation) {
        ...
        configureOptions = { id, pubID, privacyPolicy, showFree, showConsent, debug, debugLocation };
...
("use strict");
{
    ...
    class C3BannerAd {
        ...
        Load(adPersonalization, resolver) {
            ...
            const options = { adUnitId: C3AdUtils.GetAdUnit(this._adUnitId, "banner"), size: this._size, position: this._position, offset: 0, npa: adPersonalization === "NON_PERSONALIZED" ? "1" : "0" };
...
("use strict");
{
    ...
    class C3InterstitialAd {
        ...
        Load(adPersonalization, resolver) {
            const options = { adUnitId: C3AdUtils.GetAdUnit(this._adUnitId, "interstitial"), npa: adPersonalization === "NON_PERSONALIZED" ? "1" : "0" };
            this._adLoading = true;
            this._adShowing = false;
            this._loadSuccess = false;
            this._loadPromise = null;
...
("use strict");
{
    ...
    class C3RewardedAd {
        ...
        Load(adPersonalization, resolver) {
            const options = { adUnitId: C3AdUtils.GetAdUnit(this._adUnitId, "rewarded"), npa: adPersonalization === "NON_PERSONALIZED" ? "1" : "0" };
            this._adLoading = true;
            this._adShowing = false;
            this._loadSuccess = false;
            this._loadPromise = null;
...
("use strict");
{
    ...
    class C3RewardedInterstitialAd {
        ...
        Load(adPersonalization, resolver) {
            const options = { adUnitId: C3AdUtils.GetAdUnit(this._adUnitId, "rewardedInterstitial"), npa: adPersonalization === "NON_PERSONALIZED" ? "1" : "0" };
            this._adLoading = true;
            this._adShowing = false;
            this._loadSuccess = false;
            this._loadPromise = null;
...
("use strict");
{
    ...
    const Success = C3AdUtils.Success;
    const Failure = C3AdUtils.Failure;
    const IOS = self["cordova"]["platformId"] === "ios";
    const ANDROID = self["cordova"]["platformId"] === "android";
    ...
    class C3Consent {
        ...
        async RequestTrackingAuthorization() {
            if (IOS) await admob.requestTrackingAuthorization();
        }
    ...
    async function _RequestInfoUpdateForTesting(debug, debugLocation, onError) {
        ...
        try {
            if (!!debug) await self["consent"]["requestInfoUpdate"]({ debugGeography: debugGeography, testDeviceIds: testDeviceIds });
...
("use strict");
{
    ...
    addHandler("CreateInterstitialAdvert", async (id, debug, fn) => {
        if (interstitialAd) return C3AdUtils.Success(fn, "interstitial ad already created");
        if (!(await C3AdUtils.StartAdmobPlus(fn, debug))) return;
        const adPersonalization = await C3Consent.GetAdPersonalization();
    ...
    addHandler("Configure", async (id, pubID, privacyPolicy, showFree, showConsent, debug, debugLocation, showOnStartUp, fn) => {
        ...
        C3AdUtils.SetInitConfigureOptions(id, pubID, privacyPolicy, showFree, showConsent, debug, debugLocation);
        if (!(await C3AdUtils.StartAdmobPlus(fn, debug))) return;
    ...
    const HANDLER_CLASS = class MobileAdvertHandler extends self.DOMHandler {
        constructor(iRuntime) {
            ...
            this.AddRuntimeMessageHandlers([
                ...
                handler("CreateRewardedAdvert"),
                handler("ShowRewardedAdvert"),
                handler("CreateRewardedInterstitialAdvert"),
                handler("ShowRewardedInterstitialAdvert"),
                handler("Configure"),
        ...
        async _CallMethod(name, data) {
            ...
            else if (USE_EMULATOR) api = self.C3MobileAdvertsAPI.fake;
            if (!api) {
                if (!hasShownWarning) {
...
("use strict");
{
    ...
    const HANDLER_CLASS = class PlatformInfoDOMHandler extends self.DOMHandler {
        ...
        _OnGetInitialState() {
            return { screenWidth: screen.width, screenHeight: screen.height, windowOuterWidth: window.outerWidth, windowOuterHeight: window.outerHeight, safeAreaInset: this._GetSafeAreaInset(), supportsWakeLock: !!navigator["wakeLock"] };
        }
        _GetSafeAreaInset() {
            ...
            const ret = [computedStyle.getPropertyValue("--temp-sai-top"), computedStyle.getPropertyValue("--temp-sai-right"), computedStyle.getPropertyValue("--temp-sai-bottom"), computedStyle.getPropertyValue("--temp-sai-left")].map(
                (str) => {
        ...
        _OnResize() {
            this.PostToRuntime("window-resize", { windowOuterWidth: window.outerWidth, windowOuterHeight: window.outerHeight, safeAreaInset: this._GetSafeAreaInset() });
        }
    ...
    self.AudioDOMHandler = class AudioDOMHandler extends self.DOMHandler {
        ...
        *audioInstancesByTag(tag) {
        ...
        Tick() {
            ...
            this.PostToRuntime("state", { tickCount: this._lastTickCount, audioInstances: instStates, analysers: [...this._analysers].map((a) => a.GetData()) });
...
("use strict");
{
    ...
    self.C3AudioInstance = class C3AudioInstance {
        ...
        GetPanState() {
            ...
            return { pos: this._pannerPosition, orient: this._pannerOrientation, cia: pn["coneInnerAngle"], coa: pn["coneOuterAngle"], cog: pn["coneOuterGain"], uid: this._instUid };
        }
        LoadPanState(d) {
            if (!d) {
    ...
    const HANDLER_CLASS = class InstantGamesDOMHandler extends self.DOMHandler {
        ...
        async _InitializeFBInstant() {
            try {
                ...
                console.error("[Instant Games] Failed to initialize: ", err);
            }
        }
        ...
        async _OnStartGame() {
            ...
            let entryPointData = "";
            if (entryPointObj && entryPointObj.hasOwnProperty("data")) entryPointData = entryPointObj["data"];
            return {
        ...
        async _OnShare(e) {
            if (!this._isAvailable) return;
            try {
                await this._FBInstant["shareAsync"]({ intent: e["intent"], image: e["image"], text: e["text"], data: { data: e["data"] } });
            } catch (err) {
        ...
        async _OnCustomUpdate(e) {
            if (!this._isAvailable) return;
            try {
                const opts = { action: "CUSTOM", template: e["templateId"], image: e["image"], text: e["text"], data: { data: e["data"] }, strategy: e["strategy"], notification: e["notification"] };
                const cta = e["cta"];
                if (cta) opts["cta"] = cta;
        ...
        async _OnChangeContext(e) {
            ...
            try {
                ...
                if (err["code"] === "USER_INPUT") return { isOk: false, cancelled: true };
                else {
        ...
        async _OnLoadConnectedPlayers() {
            ...
            try {
                ...
                return { isOk: true, connectedPlayers: result.map((p) => ({ id: p["getID"](), name: p["getName"](), photo: p["getPhoto"]() })) };
            } catch (err) {
                console.error("[Instant Games] Failed to share: ", err);
                this.PostError();
                return { isOk: false };
        ...
        async _OnLoadPlayerScore(e) {
            ...
            try {
                ...
                return { isOk: true, score: entry["getScore"](), rank: entry["getRank"]() };
            } catch (err) {
        ...
        async _LoadLeaderboard(e) {
            ...
            try {
                ...
                return {
                    isOk: true,
                    leaderboardEntries: entries.map((e) => ({ score: e["getScore"](), rank: e["getRank"](), playerId: e["getPlayer"]()["getID"](), playerName: e["getPlayer"]()["getName"](), playerPhoto: e["getPlayer"]()["getPhoto"]() })),
                };
            } catch (err) {
        ...
        async _OnLoadAd(e) {
            ...
            try {
                ...
                else adInstance = await this._FBInstant["getRewardedVideoAsync"](placementId);
